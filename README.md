...
* Quando avaliamos uma expressão lógica, o resultado é sempre um vooleano ("true* ou *false*)
* **Operadores lógicos**
```
-------------------------------------------------
|	Operador	|	Significado	|
...
-------------------------------------------------
```
* Operador **E** - Todas as condições devem ser verdadeiras
* **Tabela verdade**
```
-------------------------------------------------
|	A	|	B	|	A&&B	|
...
-------------------------------------------------
```
* Operador **OU** - Verdadeiro se pelo menos uma das condições forem verdadeiras
* **Tabela verdade**
```
-------------------------------------------------
|	A	|	B	|	A||B	|
...
-------------------------------------------------
```
* Operador **NÃO** - Inverte o valor lógico da condição
* **Tabela verdade**
```
---------------------------------
|	A	|	!A	|
