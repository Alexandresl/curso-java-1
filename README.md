...
* List in ```ChessMatch```: ```piecesOnTheBoard```, ```capturedPieces```
  * Update ```constructor```
...
[Commit da aula](https://github.com/Alexandresl/Curso-java-1/tree/1f5ca841b9c3243eead4ed95451347f0a1132a2c)
